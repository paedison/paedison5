...
from . import models as police_models, filters


def get_filterset(request: HtmxHttpRequest):
    logged_in = request.user.is_authenticated
    psat_filter = filters.PoliceListFilter if logged_in else filters.AnonymousPoliceListFilter
...
def get_problem_images(problem: police_models.Problem):

...
from a_police.models.base_settings import (
    get_current_year, year_choice, exam_choices, unit_choices, department_choices,
...
class Unit(TimeRemarkChoiceBase):
    ...
    def __str__(self):
        return f'[Police]Unit:{self.exam}-{self.name}'
...
class Department(TimeRemarkChoiceBase):
    ...
    def __str__(self):
        return f'[Police]Department:{self.exam}-{self.unit}-{self.name}'
...
class Exam(TimeRemarkChoiceBase):
    ...
    class Meta:
        ...
        db_table = 'a_police_exam'

    def __str__(self):
        return f'[Police]Exam:{self.reference}'

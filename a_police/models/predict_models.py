...
class PredictStudent(TimeRemarkChoiceBase):
    ...
    exam = models.CharField(max_length=2, choices=exam_choices, default='프경')
    round = models.IntegerField(default=0)

    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='police_predict_students')
    ...
    class Meta:
        ...
        db_table = 'a_police_predict_student'
...
class PredictAnswerRecord(TimeRemarkChoiceBase):
    ...
    class Meta:
        ...
        db_table = 'a_police_predict_answer_record'
...
class PredictAnswerCount(TimeChoiceBase):
    ...
    class Meta:
        ...
        db_table = 'a_police_predict_answer_count'

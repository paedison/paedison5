...
from . import models as police_models
...
class AnonymousPoliceListFilter(django_filters.FilterSet):
...
class PoliceListFilter(AnonymousPoliceListFilter):
...
class AnonymousPoliceDetailFilter(django_filters.FilterSet):
